  ...
  return (
    <>
      <div className="min-h-full flex">
        <div className="flex flex-col gap-20 max-w-screen-xl mx-auto my-10 md:my-auto ">
          ...
          <div className="flex flex-col gap-10 lg:gap-0 lg:flex-row w-full justify-around items-center">
            ...
            <div className="flex flex-col gap-16 w-[80%] sm:w-[70%] md:w-[70%] lg:w-1/2 h-full justify-around items-center">
              <div className="flex flex-col gap-6 w-[95%] sm:w-[90%] lg:w-[85%]">
                <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px]/8 font-regular xl:text-justify">
              ...
              <div className="flex justify-around items-end w-[95%] sm:w-[90%] lg:w-[85%] h-[70px] lg:h-[100px]">
